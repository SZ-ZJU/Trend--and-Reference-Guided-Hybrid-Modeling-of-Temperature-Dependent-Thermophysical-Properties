...
# === 1. 读取原始数据与 slope 文件 ===
train_df = pd.read_excel("Transformed_internal_energy_Dataset.xlsx")
slope_df = pd.read_excel("slope_values.xlsx")
...
# === 4. 保存为新的 EXCEL文件 ===
output_path = "Transformed_internal_energy_with_slope.xlsx"
