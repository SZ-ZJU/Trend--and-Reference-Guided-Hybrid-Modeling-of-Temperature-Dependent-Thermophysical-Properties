...
# internal_energy_cols = df.columns[42:52]      # 第36~45列，Hvap
#
# # 3. 构建训练数据
...
# })
#
# df_result.to_excel("Internal_energy预测结果_基团加温度_RF.xlsx", index=False)
# print("✅ 已保存预测结果为: Internal_energy预测结果_基团加温度_RF.xlsx")
