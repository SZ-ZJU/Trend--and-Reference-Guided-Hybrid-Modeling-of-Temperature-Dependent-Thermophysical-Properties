...
# === 1. 读取数据 ===
df = pd.read_csv("describe word_cleaned_204_boiling.csv")  # 或 .xlsx 替换成 .read_excel
...
df_selected.to_excel("selected_25_descriptors_data_boiling_point.xlsx", index=False)
print("📁 已保存文件: selected_25_descriptors_data_boiling_point.xlsx")
