...
# comparison_df["Actual_Heat_of_Vaporization"] = y
# comparison_df["Predicted_Heat_of_Vaporization"] = y_pred
...
comparison_df.to_excel("prediction_vs_actual_with_error_analysis.xlsx", index=False)
print("✅ 已保存预测结果为: prediction_vs_actual_with_error_analysis.xlsx")
