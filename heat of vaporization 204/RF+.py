...
#
# # ==== 1. 读取数据 ====
# df = pd.read_excel("heat of vaporization.xlsx", sheet_name="Sheet1")
#
# # ==== 2. 定义列 ====
# group_cols = df.columns[13:25]   # 第14~25列：基团
# temp_cols = df.columns[25:35]    # 第26~35列：温度
# hvap_cols = df.columns[35:45]    # 第36~45列：Hvap
#
# # ==== 3. 准备 slope 所需模型输入 ====
...
# df["slope"] = slope_values  # 🔁 加入 slope 列
#
# # ==== 6. 构建训练数据 ====
