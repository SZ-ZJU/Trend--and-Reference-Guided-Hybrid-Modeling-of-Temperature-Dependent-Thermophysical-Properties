...
print(f"MSE (on Gibbs Free Energy): {mse_v:.6f}")
print(f"R2  (on Gibbs Free Energy): {r2_v:.6f}")
...
out_path = "gibbs_free_energy_actual_vs_pred_long.xlsx"
