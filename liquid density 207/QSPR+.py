...
#
# # 读取包含 slopeT 特征的数据
# df = pd.read_excel("Transformed_volume_with_slope.xlsx")
#
# # 分离特征和目标变量
...
#
# comparison_df.to_excel("prediction_vs_actual_Volume_with_slopeT.xlsx", index=False)
# print("✅ 已保存 prediction_vs_actual_Volume_with_slopeT.xlsx")
...
comparison_df.to_excel("prediction_vs_actual_Density_with_slopeT.xlsx", index=False)
print("✅ 已保存 prediction_vs_actual_Density_with_slopeT.xlsx")
