...
Cp1_residual = HVap_Tb_all - df_Tb["volume at boiling temperature"].values

# 计算 Cp2 残差（HVap_298_all - 真实的 HVap_298）
Cp2_residual = HVap_298_all - df_298["volume at normal temperature"].values

# ==== 6. 扩展残差数据，确保每个物质对应 10 行 ====
